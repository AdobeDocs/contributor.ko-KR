...
GitHub는 Git 저장소에 사용되는 웹 기반 호스팅 서비스로 [https://docs.adobe.com](docs.adobe.com) 콘텐츠를 저장하는 데 사용됩니다. 모든 프로젝트에 대해 GitHub는 주 리포지토리를 호스팅하며, 여기에서 기여자는 자신의 작업에 대한 복사본을 만들 수 있습니다.
