...
- *Branch*: 모든 리포지토리는 기본 분기(일반적으로 &quot;주&quot;라고 함)와, 주 분기에 다시 병합되도록 지정된 하나 이상의 분기를 포함합니다. 기본 분기는 현재 버전 및 컨텐츠가 게시되는 소스 역할을 합니다. 리포지토리의 다른 모든 분기가 생성되어 나오는 상위 분기입니다.
...
프로젝트의 기본/기본 분기는 프로젝트의 현재 컨텐츠 버전으로 사용됩니다. 주 분기 및 이 분기에서 생성된 분기의 내용은 문서 항목들의 구성에 맞추어 조정됩니다. 하위 디렉토리는 내용과 이미지 자산을 조직하는 데 사용됩니다.
