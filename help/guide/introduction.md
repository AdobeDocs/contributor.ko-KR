...
* ❶ 페이지의 유용성을 평가하고 선택적 주석 ❷을(를) 작성하십시오.
...
이 안내서에서는 이 자료 세트에 상호 작용하고 기여하기 위해 알아야 할 사항을 간략하게 설명합니다.
...
1. 문서 하단에 표시되는 피드백 영역에서 **[!UICONTROL Detailed feedback options]**&#x200B;를 클릭한 다음 **[!UICONTROL Suggest an edit]**&#x200B;를 클릭하여 GitHub의 Markdown 소스 파일로 이동합니다.
   ...
   ![이 페이지 아이콘 편집](/help/guide/assets/feedback-suggest-edit.png)
...
Experience League의 협업 설명서 팀과 모든 작가, 내용 생산자의 감사를 전합니다. 도와주셔서 감사합니다.
